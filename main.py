...
def main():
    ...
    # print_model_summary(model, input_size=[(3, reshape_size, reshape_size)] * 3, device=device, reshape_size=reshape_size)
    ...
    with torch.no_grad():
        ...
        for i in range(len(sample_images)):
            ...
            att_map1 = att_map1.squeeze(0)  # [1024, 1024]
            att_map2 = att_map2.squeeze(0)
            att_map3 = att_map3.squeeze(0)
